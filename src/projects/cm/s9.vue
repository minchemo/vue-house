      ...
      caption: [
        {
          ...
          desc: "●開闊公領域空間，無走道虛坪浪費 ●客廳、餐廳、廚房皆有獨立開窗面，市面珍稀房2衛規劃 ●主臥空間媲美3房規劃，可設計行走式更衣空間 ●兩房可規劃雙人床與完整收納空間 ●低台度開窗設計，採光極大化",
        },
        {
          btn: "29坪可規劃三房",
          title: "房衛開窗雙採光<br/>有感建築超收納",
          desc: "●獨立玄關空間，落塵收納一次滿足 ●高坪效3房空間，公領域舒適完整 ●多功能空間，可規劃書房、臥室、小孩玩具房 ●低台度開窗設計，採光極大化 ●開放式餐廚設計，可規劃完整餐廳空間，同級產品稀有",
        },
        {
          btn: "36坪可規劃三房",
          title: "敞亮邊間藏風光<br/>超規格舒活闊居",
          desc: "●獨立玄關空間，落塵收納一次滿足 ●複合式餐廳規劃，可設計餐櫃、酒櫃，收納齊全 ●前後陽台配置，景觀晾衣，全能滿足 ●公私領域分明，隱私性高 ●主臥室配置四件式衛浴，飯店式享受 ●低台度開窗設計，採光極大化",
        },
      ],
    };
  },
