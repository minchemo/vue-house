...
.bg-color1{background-color: #048;}
.hover\:bg-color2:hover{background-color:#000;}
...
.modal-box{
  img{filter: invert(16%) sepia(80%) saturate(2060%) hue-rotate(197deg) brightness(100%) contrast(100%);
  }
}
