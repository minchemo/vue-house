<template>
	<article class="s3 relative z-20">
		<img class="cloud" src="@/section/s3/cloud.png" alt="" srcset="">

		<div class="intro">
			<div class="t1">蘆洲下一站 萬坪公園城</div>
			<div class="t2">年度鉅獻 敬邀珍藏 夢想與理想一次到位</div>
			<div class="t3">一期夢想實現，二期理想啟城</div>
			<div class="t4">「快樂王國」NO.1夢享城熱銷，信手拈來公園水岸捷運美好總和<br />
...
.s3 {
	...
	.content {
		@apply absolute left-1/2 -translate-x-1/2 flex;
		bottom: size(127);
		width: size(1450);
		padding: size(55) size(68);
		background: rgba(9, 36, 23, 0.47);
		.l {
			.t1 {
				color: white;
				font-size: size(55);
