...
const imgs = [
  {
    ...
    content: '宗大以建設起家，從1991年創立至今已超越半甲子。以「宗親人文，大隱美學」為理念，擘建逾50件建築作品，超過3000戶客戶幸福成家。通過ISO 9002國際品質認證，從透天、大樓，到大型造鎮，台南的繁榮發展處處皆可見到宗大建設蹤跡。'
  },
  {
  ...
  },
  {
    ...
    imgs: [
      ...
      {
        url: new URL(`../section/s3/04/2.png`, import.meta.url).href,
        caption: '建築業績｜凌波揚'
      },
      {
        url: new URL(`../section/s3/04/2.png`, import.meta.url).href,
