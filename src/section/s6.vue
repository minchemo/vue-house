<template>
  ...
  <!--div class="txt">
    ...
    <div class="main">
      <div class="txt">
    <h4 class="subtitle" data-aos="fade-up" data-aos-delay="200">繁華孕育 水綠森翠</h4>
        <p class="desc" data-aos="fade-up" data-aos-delay="400">正迎國中國小雙學區預定地、未來萬坪親水公園；加上新莊中央綠肺66,000坪運動公園，林蔭大道、陽光草坪、景觀湖泊…環擁綠金奢華。</p>
      </div>
    </div>
    ...
    <img src="./s6/style.svg" v-if="!$isMobile()" class="style" alt="" data-aos="fade-up" data-aos-delay="0" data-aos-duration="1000"/>
