...
const list1 = [
        ["實施者", "眾德建設股份有限公司"],
        ["基地位置", "本案位於文山區集英街、指南路一段、保儀路及保儀路13巷所圍街廓內之南側，為一非完整街廓，共13筆土地，總面積為2,646.00㎡(800.42坪)"],
        ["更新地區", "位於107年12月10日府都新字第10720232311號函公告實施「劃定臺北市都市更新地區暨擬定都市更新計畫案『文山-6捷運Y2A站周邊更新地區』」範圍內"],
        ["基地面積(㎡)", "2646㎡"],
        ["使用分區", "第三種商業區"],
        ["更新規劃", "弘傑不動產事業股份有限公司"],
        ["建築設計", "A8聯合建築師事務所"],
