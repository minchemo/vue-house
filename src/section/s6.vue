...
const imgs = [
  ...
  {
    img: globals.$isMobile() ? new URL("./s6/5_m.jpg", import.meta.url).href : new URL("./s6/5.jpg", import.meta.url).href,
    t1: '出類拔萃',
    t2: '聚地理、生態、未來發展等優勢的林口，吸引眾多歸國華僑、台商、機師、外籍人士擇居於此，「馬禮遜美國學校」、<br class="hidden md:block"/>「新北美國學校」、「康橋國際學校」等異國菁英院校因應而生，形塑出林口高質感、高資產的生活風範。'
  },
  {
    img: globals.$isMobile() ? new URL("./s6/6_m.jpg", import.meta.url).href : new URL("./s6/6.jpg", import.meta.url).href,
    t1: '出類拔萃',
    t2: '聚地理、生態、未來發展等優勢的林口，吸引眾多歸國華僑、台商、機師、外籍人士擇居於此，「馬禮遜美國學校」、<br class="hidden md:block"/>「新北美國學校」、「康橋國際學校」等異國菁英院校因應而生，形塑出林口高質感、高資產的生活風範。'
  },
]
