<template>
  <article class="s4">
   <!--   -->  <div class="txt">
    <h3 class="title" data-aos="fade-up" data-aos-delay="0">作夢想不到!豪宅地段<br v-if="isMobile">用小資價輕鬆拿下</h3>
    <h4 class="subtitle" data-aos="fade-up" data-aos-delay="200">藝術水岸園區 ✕ 國民運動中心<br v-if="isMobile"> 每個人都想住的新名宅特區</h4>   
      </div>
    <Fullview />
