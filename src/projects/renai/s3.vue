  ...
  <div class="s3" ref="s3">
    ...
    <div class="decor parallax-item" data-depth="0.25">
      <img
        class="d1"
        data-aos="fade"
        src="@/projects/renai/s3/decor1.svg"
        alt=""
        srcset=""
      />
      <img
        class="d2"
        data-aos="fade"
        src="@/projects/renai/s3/decor3.svg"
        alt=""
        srcset=""
      />
      <div class="title" data-aos="fade" data-aos-delay="300">博愛特區</div>
    </div>
  </div>
</template>
<style lang="scss">
...
export default {
  ...
  data() {
    return {
      ...
      imgs: [
        {
          img: require("@/projects/renai/s3/1.jpg"),
          caption: "總統府"
        },
        {
          img: require("@/projects/renai/s3/2.jpg"),
          caption: "景福門"
        },
        {
          img: require("@/projects/renai/s3/3.jpg"),
          caption: "台灣高等法院"
        },
        {
          img: require("@/projects/renai/s3/4.jpg"),
          caption: "外交部"
        },
        {
          img: require("@/projects/renai/s3/5.jpg"),
          caption: "監察院"
        },
      ]
    };
