...
.bg-color1{background-color: #785A4F;}
.hover\:bg-color2:hover{background-color:#4b2d22;}
...
.modal-box{
  img{filter: invert(34%) sepia(41%) saturate(313%) hue-rotate(331deg) brightness(97%) contrast(88%);
  }
}
