<template>
  ...
  <div class="contact-info mx-auto  flex flex-col items-center justify-between">
    ...
    <div class="flex justify-between w-full contact-item-box no-gap" v-if="info.address">
      ...
      <div class="flex contact-item justify-center items-center googlemap"
        ...
        <img src="//h65.tw/img/gmap.svg" alt="導航 GoogleMap" srcset="" />
  ...
  <!-- Mobile contact info -->
    ...
    <div class="flex flex-1 flex-col contact-item justify-center items-center" 
      ...
      <img src="//h65.tw/img/phone.svg" alt="撥打電話" srcset="" />
      <div>撥打電話</div>
    </div>
    <div class="flex flex-1 flex-col contact-item justify-center items-center"
      @click="modalOpen = true; modalType = 'fb'">
      <img src="//h65.tw/img/messenger.svg" alt="FB 諮詢" srcset="" />
      <div>FB 諮詢</div>
    </div>
    <div class="flex flex-1 flex-col contact-item justify-center items-center" @click="scrollTo('.order')">
      <img src="//h65.tw/img/pen.svg" alt="預約賞屋" srcset="" />
      <div>預約賞屋</div>
    </div>
    <div class="flex flex-1 flex-col contact-item justify-center items-center"
      @click="modalOpen = true; modalType = 'gmap'"  v-if="info.address" >
      <img src="//h65.tw/img/gmap.svg" alt="地圖導航" srcset="" />
      <div>地圖導航</div>
    </div>
  </div>
  ...
  <div class="modal -mt-20 md:-mt-72">
    <div class="modal-box py-12 relative flex flex-col items-center justify-center">
      ...
      <!-- icon -->
      <img class="h-12" v-if="modalType == 'phone'" src="//h65.tw/img/phone.svg" alt="phone" srcset="" />
      <img class="h-12" v-else-if="modalType == 'fb'" src="//h65.tw/img/messenger.svg" alt="fb" srcset="" />
      <img class="h-12" v-else-if="modalType == 'gmap'" src="//h65.tw/img/gmap.svg" alt="gmap" srcset="" />
      <!-- title -->
...
.hover\:bg-color2:hover{background-color:#d65012;}
...
.modal-box{
  img{filter: invert(61%) sepia(43%) saturate(5133%) hue-rotate(340deg) brightness(97%) contrast(91%);
