...
const imgs = [
  {
    ...
    caption: "東京羽田機場",
    subtitle: "日本國土營造開發<br>日系究極精工 世界工程御用",
 ...
 },
  {
    ...
    caption: "",
    subtitle: "金質建築代名詞<br>審議級建築大師 周劍平",
  ...
  },
  {
    ...
    caption: "",
    subtitle: "橫掃全球設計大獎<br>空間美學設計師 王正行",
  ...
  },
  {
    ...
    caption: "",
    subtitle: "國際建築景觀視野<br>信義豪宅六國景觀設計大師 蘇瑞泉",
  ...
  },
  {
    ...
    caption: "",
    subtitle: "耐震系統權威<br>摩天建築御用  劉勇男 結構技師",
  ...
  },
  {
    ...
    caption: "",
    subtitle: "以國父紀念館規格打造建築光影<br>台灣燈光設計翹楚 袁宗南 燈光大師",
