<template>
  <div class="contact-info mx-auto bg-[transparent] flex flex-col items-center justify-between">
    ...
    <div class="flex justify-between w-full contact-item-box no-gap">
      ...
      <div class="flex contact-item justify-center items-center googlemap"
        ...
        <img src="@/section/form/gmap.svg" alt="雙橡園" srcset="" />
  ...
  <!-- Mobile contact info -->
    ...
    <div class="flex flex-1 flex-col contact-item justify-center items-center" @click="scrollTo('.order')">
      <img src="@/section/form/pen.svg" alt="雙橡園" srcset="" />
      <div>預約賞屋</div>
    </div>
    <div class="flex flex-1 flex-col contact-item justify-center items-center"
      @click="modalOpen = true; modalType = 'gmap'">
  ...
  <div class="modal -mt-20 md:-mt-72">
    <div class="modal-box py-12 relative flex flex-col items-center justify-center">
      ...
      <!-- icon -->
      <img class="h-12" v-if="modalType == 'phone'" src="@/section/form/phone.svg" alt="雙橡園" srcset="" />
      <img class="h-12" v-else-if="modalType == 'fb'" src="@/section/form/messenger.svg" alt="雙橡園" srcset="" />
      <img class="h-12" v-else-if="modalType == 'gmap'" src="@/section/form/gmap.svg" alt="雙橡園" srcset="" />
      <!-- title -->
