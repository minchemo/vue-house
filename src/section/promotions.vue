<template>
  <article class="promotions" ref="promotions">
...
const imgs = [
  {
    img:new URL("./promotions/1.jpg", import.meta.url).href ,
    caption: "台南市政府"
  },
  {
    img:new URL("./promotions/2.jpg", import.meta.url).href ,
    caption: "新光三越"
  },
  {
    img:new URL("./promotions/3.jpg", import.meta.url).href ,
    caption: "夏慕尼"
  },
  {
    img:new URL("./promotions/4.jpg", import.meta.url).href ,
    caption: "燦坤"
  },
  {
    img:new URL("./promotions/5.jpg", import.meta.url).href ,
    caption: "家樂福-安平店"
  },
  {
    img:new URL("./promotions/6.jpg", import.meta.url).href ,
    caption: "碳佐麻里"
  },
]
</script>
