<template>
  <div class="section9">
    ...
    <!-- <div class="img1"><img src="./s2/img.png" alt=""></div> -->
      ...
      <!-- <div class="an"><img src="./s1/img.png" alt="水漾"></div> -->
    </div>
...
.logobg {
  ...
  @include div_l_pc(704, 758, 0, 245);
      ...
      slideList: [
        {
          ...
          title: '',
          desc:
            '挑高的室內空間讓家盡情舒展，多出來的空間可以收納行李箱、戰利品、換季衣物，裝修變化多更多，盡情打造出獨具風格的家。',
          subtitle: '3米6空間',
          name: '3D參考示意圖',
        },
        {
