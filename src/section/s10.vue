    ...
    <div class="main">
      <div class="txt">
        <transition name="fade" mode="out-in">
          <h4 class="subtitle font-['Noto_Serif_TC',serif]" :key="currentImg.subtitle" v-html="currentImg.subtitle">
          </h4>
        </transition>
        <transition name="fade" mode="out-in">
...
const imgs = [
  {
    ...
    caption: "",
    subtitle: "假字假字假字<br><span>假字假字假字假字假字假字</span>",
    desc: "假字假字假字，假字假字假字，假字假字假字假字假字假字，假字假字假字假字假字假字，假字假字假字假字假字假字。假字假字假字、假字假字假字，假字假字假字。<br><br>假字假字假字、假字假字假字、假字假字假字、假字假字假字",
  },
  {
    img: new URL("./s10/2.webp", import.meta.url).href,
    caption: "",
    subtitle: "假字假字假字<br><span>假字假字假字</span>",
    desc: "假字假字假字，假字假字假字，假字假字假字，假字假字假字、假字假字假字，假字假字假字假字假字假字，假字假字假字假字假字假字。<br><br>假字假字假字、假字假字假字、假字假字假字、假字假字假字",
  },
  {
    img: new URL("./s10/3.webp", import.meta.url).href,
    caption: "",
    subtitle: "假字假字假字<br><span>假字假字假字</span>",
    desc: "假字假字假字，假字假字假字、假字假字假字，假字假字假字，假字假字假字、假字假字假字。<br><br>假字假字假字",
  },
  {
