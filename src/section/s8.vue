<template>
  <article class="s8">
    <img
      class="bg"
      src="@/section/s8/bg.webp" alt="bg" v-if="!$isMobile()"
    />
    <img
      class="bg"
    ...
    <div class="t">
      ...
      <div class="t2" v-if="!isMobile" data-aos="fade-up" data-aos-delay="0">
        真正動人的建築，是一份來自內心的澄澈清明<br />
        石材與格柵的虛實相生，輕重諧和<br />
        透過俐落的線條，內斂的建築原色<br />
        為建築本體注入東方人文風的含蓄本質<br />
        彷如水墨揮灑在城市的畫布之上<br />
        在蔚藍的天空下，展現空靈與意境<br />
        這是一份力透紙背的精工感動，在內斂中更顯雍容品味
      </div>
      <div class="t2" v-else data-aos="fade-up" data-aos-delay="0">
        真正動人的建築，是一份來自內心的澄澈清明<br />
        石材與格柵的虛實相生，輕重諧和<br />
        透過俐落的線條，內斂的建築原色<br />
        為建築本體注入東方人文風的含蓄本質<br />
    ...
    ></div>
    <div class="caption">
      本外觀合成圖僅供參考，外觀及環境以核准之使用執照竣工圖及實際現場為準。
    </div>
  </article>
</template>
