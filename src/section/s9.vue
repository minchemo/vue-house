...
const imgs = ref([
    {
        img: globals.$isMobile() ? new URL("../section/s9/tem.jpg", import.meta.url).href : new URL("../section/s9/tem.jpg", import.meta.url).href,
        caption: '圖說',
        title: '精緻2房  精品飯店美學',
        btn: '<span>23</span>坪/二房'
    },
    {
        img: globals.$isMobile() ? new URL("../section/s9/tem.jpg", import.meta.url).href : new URL("../section/s9/tem.jpg", import.meta.url).href,
        caption: '圖說',
        title: '精緻3房  精品飯店美學',
        btn: '<span>33</span>坪/三房'
    },
    {
        img: globals.$isMobile() ? new URL("../section/s9/tem.jpg", import.meta.url).href : new URL("../section/s9/tem.jpg", import.meta.url).href,
        caption: '圖說',
