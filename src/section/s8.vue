<template>
    <article class="s8">
        <div class="bg">
            <img src="./s8/s81_img.png" class="bg1" v-if="!isMobile">
            <img src="./s8/bgm.webp" class="bg1" v-else>
        </div>
        <div class="main">
            <div class="txt">
                <p class="desc" data-aos="fade-left" data-aos-delay="0">區內5大主題公園，讓自然成為日常生活的一部分</p>
            </div>
            <img src="./s8/s8-txt-convenient.svg" class="en" data-aos="fade-left" data-aos-delay="500">
        </div>
