...
.txt {
  ...
  text-align: justify;
    ...
    .desc{position: absolute;bottom: size(-420);left: size(-450);text-align: justify;}
...
@media screen and (max-width: 767px) {
  ...
  .txt {
    ...
    text-align: center;
    .en{width:sizem(250);opacity: 1;margin:1.5em auto 0em;}
...
const imgs = [
  {
    img:new URL("./s6/bg.jpg", import.meta.url).href,
    caption: "情境示意圖"
  },
  {
