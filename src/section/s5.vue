<template>
  <article class="s5" ref="s5">
    ...
    <div class="main">
      <div class="txt">
    <div class="title"><img src="./s5/titleicon.png">文風</div>
        <h3 class="subtitle" data-aos="fade-up" data-aos-delay="0">高鐵金軸 億級科技領地</h3>
...
.s5 {
  ...
  flex-wrap: wrap;
    ...
    .en{margin: size(170) auto 0;width: size(1800);position: absolute;top: 0;left: 0;right: 0;}
  .img{position: absolute;bottom: 0;left: 0;width: size(400);z-index: 3
  }
