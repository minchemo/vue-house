...
const imgs = [
  ...
  },
  {
    ...
    imgs: [
      ...
      {
        url: globals.$isMobile() ? new URL("../section/s3/04/2_m.jpg", import.meta.url).href : new URL("../section/s3/04/2.jpg", import.meta.url).href,
        caption: '吉源控股廈門廠'
      },
      {
        url: globals.$isMobile() ? new URL("../section/s3/04/3_m.jpg", import.meta.url).href : new URL("../section/s3/04/3.jpg", import.meta.url).href,
        caption: '吉源控股廠房實景'
      },
    ],
