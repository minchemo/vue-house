...
.bg-color1{background-color: #085C5C;}
.hover\:bg-color2:hover{background-color:#04836E;}
...
.modal-box{
  img{filter:  invert(27%) sepia(15%) saturate(3565%) hue-rotate(138deg) brightness(93%) contrast(94%);
  }
}
