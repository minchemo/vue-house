...
<template>
  <article class="s5">
    <div class="bg">
      <img src="./s5/bg.webp" class="bg1" v-if="!isMobile">
      <img src="./s5/bgm.webp" class="bg1" v-else>
    </div>
    <div class="main">
      <!--div class="txt">
        <p class="desc" data-aos="fade-left" data-aos-delay="0">鄰近國道及主要幹道，快速通勤，暢行無阻<br>桃捷綠線G09，散步就到</p>
      </div-->
        <img src="./s5/en.svg" class="en" data-aos="fade-left" data-aos-delay="500">
    </div>
...
@media screen and (max-width: 767px) {
  ...
  .bg{overflow: hidden;width: 100%; position: absolute; height: auto; top: sizem(30);
  .bg1{width: 100%;}
}
