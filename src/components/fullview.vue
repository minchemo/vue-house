<template>
    <div class="viewbox" ref="viewbox">
        <img ref="viewImg" src="@/section/s2/map1.webp" alt="" srcset="">
...
.viewbox {
    ...
    > img {
        height: 100%;
        max-width: unset;
        background:url("@/section/s2/map2.webp") 50%;
...
@media screen and (max-width: 767px) {
    .viewbox {
        ...
        .mask {
            ...
            opacity: 1;
            transition: all 1s;
            background-color: rgba($color: #204070, $alpha: 0.5);
