...
<!-- 動態 select end-->
      ...
      <!-- Recaptcha -->
      <vue-recaptcha class="flex justify-center mt-8 z-10 relative" ref="recaptcha" :sitekey="info.recaptcha_site_key_v2"
...
<div v-else class="send-load text-[#FFF] z-10 relative" style="letter-spacing: 0.7em;
  text-indent: 0.9em;
  height:100%;">
  <svg
    class="h-5 w-5 mr-2"
