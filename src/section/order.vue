...
<!--  -->
      ...
      <div class="form mx-auto relative flex justify-center">
        ...
        <div class="left h-full flex flex-col justify-between items-center font-['Noto_Sans_TC',sans-serif]">
          <div class="name">
          <!-- 姓名 -->
          <label class="row">
  ...
  >
    ...
    <select v-model="formData.area" class="select w-full">
      ...
      <!-- submit -->
      <div class="sendall mt-8 mb-12 mx-auto font-['Noto_Sans_TC',sans-serif]">
