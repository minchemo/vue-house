...
.s1 {
  ...
  .t22{
    color: #AE9562;text-align: center;
    padding: 1.35em .5em;
...
@keyframes tree{
  ...
  .tree1{
    ...
    @media screen and (min-width: 768px) {
      top: size(90);left: size(1234);width: size(3410);
    }
  }
  .tree2{
    ...
    @media screen and (min-width: 768px) {
      top: size(785);right: size(1210);width: size(3410);
