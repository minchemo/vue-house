...
.bg-color1{background-color: #EA5A03;}
.hover\:bg-color2:hover{background-color:#C30D23;}
...
.modal-box{
  img{filter: invert(12%) sepia(82%) saturate(5792%) hue-rotate(347deg) brightness(81%) contrast(97%);
  }
}
