...
export default {
  ...
  computed: {
    group() {
      return this.slides.find(item => item.group == this.activeGroup)
    }
  },
  watch: {
    group() {
      this.group = this.slides.find(item => item.group == this.activeGroup);
    }
  },
  data() {
    return {
